...
/// Implementation of solid dynamics with Guo force term
template<typename T, template<typename U> class Descriptor>
class GuoExternalForceSolidHermiteDynamics : public ExternalForceDynamics<T,Descriptor> {
public:
/* *************** Construction / Destruction ************************ */
    GuoExternalForceSolidHermiteDynamics(T omega_, T rhoMaterial_);
    GuoExternalForceSolidHermiteDynamics(HierarchicUnserializer& unserializer);

    /// Clone the object on its dynamic type.
    virtual GuoExternalForceSolidHermiteDynamics<T,Descriptor>* clone() const;
...
/// Solid dynamics à terminer et tester et enlever ce qui est inutile
/// Implementation of solid dynamics with a simple force term type naive
template<typename T, template<typename U> class Descriptor>
class GravityLikeExternalForceSolidHermiteDynamics : public ExternalForceDynamics<T,Descriptor> {
public:
/* *************** Construction / Destruction ************************ */
    GravityLikeExternalForceSolidHermiteDynamics(T omega_, T rhoMaterial_);
    GravityLikeExternalForceSolidHermiteDynamics(HierarchicUnserializer& unserializer);

    /// Clone the object on its dynamic type.
    virtual GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>* clone() const;
...
/// Implementation of solid dynamics with a simple force term type naive
template<typename T, template<typename U> class Descriptor>
class GravityLikeExternalForceSolidDynamics : public ExternalForceDynamics<T,Descriptor> {
public:
/* *************** Construction / Destruction ************************ */
    GravityLikeExternalForceSolidDynamics(T omega_, T rhoMaterial_);
    GravityLikeExternalForceSolidDynamics(HierarchicUnserializer& unserializer);

    /// Clone the object on its dynamic type.
    virtual GravityLikeExternalForceSolidDynamics<T,Descriptor>* clone() const;
...
/// Implementation of Vlasov dynamics with a simple force term type naive
template<typename T, template<typename U> class Descriptor>
class GravityLikeExternalForceVlasovDynamics : public ExternalForceDynamics<T,Descriptor> {
public:
/* *************** Construction / Destruction ************************ */
    GravityLikeExternalForceVlasovDynamics(T omega_);
    GravityLikeExternalForceVlasovDynamics(HierarchicUnserializer& unserializer);

    /// Clone the object on its dynamic type.
    virtual GravityLikeExternalForceVlasovDynamics<T,Descriptor>* clone() const;
...
/// Vlasov dynamics à terminer et tester et enlever ce qui est inutile
/// Implementation of Vlasov dynamics with Guo force term
template<typename T, template<typename U> class Descriptor>
class GuoExternalForceVlasovDynamics : public ExternalForceDynamics<T,Descriptor> {
public:
/* *************** Construction / Destruction ************************ */
    GuoExternalForceVlasovDynamics(T omega_);
    GuoExternalForceVlasovDynamics(HierarchicUnserializer& unserializer);

    /// Clone the object on its dynamic type.
    virtual GuoExternalForceVlasovDynamics<T,Descriptor>* clone() const;
