...
/* *************** Class GuoExternalForceSolidHermiteDynamics ********************************** */

template<typename T, template<typename U> class Descriptor>
int GuoExternalForceSolidHermiteDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,GuoExternalForceSolidHermiteDynamics<T,Descriptor> >("SolidHermite_ExternalForce_Guo");

/** \param omega_ relaxation parameter, related to the dynamic viscosity
 */
template<typename T, template<typename U> class Descriptor>
GuoExternalForceSolidHermiteDynamics<T,Descriptor>::GuoExternalForceSolidHermiteDynamics(T omega_, T rhoMaterial_)
    : ExternalForceDynamics<T,Descriptor>(omega_),
    rhoMaterial(rhoMaterial_)
{ }

template<typename T, template<typename U> class Descriptor>
GuoExternalForceSolidHermiteDynamics<T,Descriptor>::GuoExternalForceSolidHermiteDynamics(HierarchicUnserializer& unserializer)
    : ExternalForceDynamics<T,Descriptor>(T()),
    rhoMaterial(T())
{
    this->unserialize(unserializer);
...
template<typename T, template<typename U> class Descriptor>
GuoExternalForceSolidHermiteDynamics<T,Descriptor>* GuoExternalForceSolidHermiteDynamics<T,Descriptor>::clone() const {
    return new GuoExternalForceSolidHermiteDynamics<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor>
int GuoExternalForceSolidHermiteDynamics<T,Descriptor>::getId() const {
    return id;
}

template<typename T, template<typename U> class Descriptor>
void GuoExternalForceSolidHermiteDynamics<T,Descriptor>::collide (
        Cell<T,Descriptor>& cell,
        BlockStatistics& statistics )
{
    ...
    T uSqr = dynamicsTemplates<T,Descriptor>::bgk_ma2_collision_solid_hermite(cell, rhoBar, j, this->getOmega(), rhoMaterial);
...
template<typename T, template<typename U> class Descriptor>
void GuoExternalForceSolidHermiteDynamics<T,Descriptor>::collideExternal (
        Cell<T,Descriptor>& cell, T rhoBar, Array<T,Descriptor<T>::d> const& j, T thetaBar, BlockStatistics& stat)
{
    ...
    T uSqr = dynamicsTemplates<T,Descriptor>::bgk_ma2_collision_solid_hermite(cell, rhoBar, newJ, this->getOmega(), rhoMaterial);
    externalForceTemplates<T,Descriptor>::addGuoForce(cell, u, this->getOmega(), (T)1);
...
template<typename T, template<typename U> class Descriptor>
T GuoExternalForceSolidHermiteDynamics<T,Descriptor>::computeEquilibrium (
        plint iPop, T rhoBar, Array<T,Descriptor<T>::d> const& j,
        T jSqr, T thetaBar) const
{
    T invRho = Descriptor<T>::invRho(rhoBar);
    return dynamicsTemplates<T,Descriptor>::bgk_ma2_equilibrium_solid_hermite(iPop, rhoBar, invRho, j, jSqr);
}

template<typename T, template<typename U> class Descriptor>
void GuoExternalForceSolidHermiteDynamics<T,Descriptor>::serialize(HierarchicSerializer& serializer) const
{
    ExternalForceDynamics<T,Descriptor>::serialize(serializer);
    serializer.addValue(rhoMaterial);
}

template<typename T, template<typename U> class Descriptor>
void GuoExternalForceSolidHermiteDynamics<T,Descriptor>::unserialize(HierarchicUnserializer& unserializer)
{
    ExternalForceDynamics<T,Descriptor>::unserialize(unserializer);
    rhoMaterial = unserializer.readValue<T>();
}

/// Solid dynamics à terminer et tester et enlever ce qui est inutile
/* *************** Class GravityLikeExternalForceSolidHermiteDynamics ********************************** */

template<typename T, template<typename U> class Descriptor>
int GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor> >("SolidHermite_ExternalForce_GravityLike");

/** \param omega_ relaxation parameter, related to the dynamic viscosity
 */
template<typename T, template<typename U> class Descriptor>
GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::GravityLikeExternalForceSolidHermiteDynamics(T omega_, T rhoMaterial_)
    : ExternalForceDynamics<T,Descriptor>(omega_),
    rhoMaterial(rhoMaterial_)
{ }

template<typename T, template<typename U> class Descriptor>
GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::GravityLikeExternalForceSolidHermiteDynamics(HierarchicUnserializer& unserializer)
    : ExternalForceDynamics<T,Descriptor>(T()),
    rhoMaterial(T())
{
    this->unserialize(unserializer);
...
template<typename T, template<typename U> class Descriptor>
GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>* GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::clone() const {
    return new GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor>
int GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::getId() const {
    return id;
}

template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::collide (
        Cell<T,Descriptor>& cell,
        BlockStatistics& statistics )
{
    T rhoBar = this->computeRhoBar(cell);
    ...
    T uSqr = dynamicsTemplates<T,Descriptor>::bgk_ma2_collision_solid_hermite(cell, rhoBar, j, this->getOmega(), rhoMaterial);
    externalForceTemplates<T,Descriptor>::addGravityLikeForce(cell);
...
template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::collideExternal (
        Cell<T,Descriptor>& cell, T rhoBar, Array<T,Descriptor<T>::d> const& j, T thetaBar, BlockStatistics& stat)
{
    Array<T,Descriptor<T>::d> u;
    this->computeVelocityExternal(cell, rhoBar, j, u);
...
template<typename T, template<typename U> class Descriptor>
T GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::computeEquilibrium (
        plint iPop, T rhoBar, Array<T,Descriptor<T>::d> const& j,
        T jSqr, T thetaBar) const
{
    T invRho = Descriptor<T>::invRho(rhoBar);
...
template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::serialize(HierarchicSerializer& serializer) const
{
    ExternalForceDynamics<T,Descriptor>::serialize(serializer);
    serializer.addValue(rhoMaterial);
}
...
template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceSolidHermiteDynamics<T,Descriptor>::unserialize(HierarchicUnserializer& unserializer)
{
    ExternalForceDynamics<T,Descriptor>::unserialize(unserializer);
    rhoMaterial = unserializer.readValue<T>();
}
...
/// Solid dynamics à terminer et tester et enlever ce qui est inutile
/* *************** Class GravityLikeExternalForceSolidDynamics ********************************** */

template<typename T, template<typename U> class Descriptor>
int GravityLikeExternalForceSolidDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,GravityLikeExternalForceSolidDynamics<T,Descriptor> >("Solid_ExternalForce_GravityLike");

/** \param omega_ relaxation parameter, related to the dynamic viscosity
 */
template<typename T, template<typename U> class Descriptor>
GravityLikeExternalForceSolidDynamics<T,Descriptor>::GravityLikeExternalForceSolidDynamics(T omega_, T rhoMaterial_)
    : ExternalForceDynamics<T,Descriptor>(omega_),
    rhoMaterial(rhoMaterial_)
{ }

template<typename T, template<typename U> class Descriptor>
GravityLikeExternalForceSolidDynamics<T,Descriptor>::GravityLikeExternalForceSolidDynamics(HierarchicUnserializer& unserializer)
    : ExternalForceDynamics<T,Descriptor>(T()),
    rhoMaterial(T())
{
    this->unserialize(unserializer);
...
template<typename T, template<typename U> class Descriptor>
GravityLikeExternalForceSolidDynamics<T,Descriptor>* GravityLikeExternalForceSolidDynamics<T,Descriptor>::clone() const {
    return new GravityLikeExternalForceSolidDynamics<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor>
int GravityLikeExternalForceSolidDynamics<T,Descriptor>::getId() const {
    return id;
}

template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceSolidDynamics<T,Descriptor>::collide (
        Cell<T,Descriptor>& cell,
        BlockStatistics& statistics )
{
    T rhoBar = this->computeRhoBar(cell);
    ...
    T uSqr = dynamicsTemplates<T,Descriptor>::bgk_ma2_collision_solid(cell, rhoBar, j, this->getOmega(), rhoMaterial);
    externalForceTemplates<T,Descriptor>::addGravityLikeForce(cell);
...
template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceSolidDynamics<T,Descriptor>::collideExternal (
        Cell<T,Descriptor>& cell, T rhoBar, Array<T,Descriptor<T>::d> const& j, T thetaBar, BlockStatistics& stat)
{
    Array<T,Descriptor<T>::d> u;
    this->computeVelocityExternal(cell, rhoBar, j, u);
    ...
    T uSqr = dynamicsTemplates<T,Descriptor>::bgk_ma2_collision_solid(cell, rhoBar, newJ, this->getOmega(), rhoMaterial);
    externalForceTemplates<T,Descriptor>::addGravityLikeForce(cell);
...
template<typename T, template<typename U> class Descriptor>
T GravityLikeExternalForceSolidDynamics<T,Descriptor>::computeEquilibrium (
        plint iPop, T rhoBar, Array<T,Descriptor<T>::d> const& j,
        T jSqr, T thetaBar) const
{
    T invRho = Descriptor<T>::invRho(rhoBar);
    return dynamicsTemplates<T,Descriptor>::bgk_ma2_equilibrium_solid(iPop, rhoBar, invRho, j, jSqr);
}

template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceSolidDynamics<T,Descriptor>::serialize(HierarchicSerializer& serializer) const
{
    ExternalForceDynamics<T,Descriptor>::serialize(serializer);
    serializer.addValue(rhoMaterial);
}
...
template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceSolidDynamics<T,Descriptor>::unserialize(HierarchicUnserializer& unserializer)
{
    ExternalForceDynamics<T,Descriptor>::unserialize(unserializer);
    rhoMaterial = unserializer.readValue<T>();
}
...
/* *************** Class GravityLikeExternalForceVlasovDynamics ********************************** */

template<typename T, template<typename U> class Descriptor>
int GravityLikeExternalForceVlasovDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,GravityLikeExternalForceVlasovDynamics<T,Descriptor> >("Vlasov_ExternalForce_GravityLike");

/** \param omega_ relaxation parameter, related to the dynamic viscosity
 */
template<typename T, template<typename U> class Descriptor>
GravityLikeExternalForceVlasovDynamics<T,Descriptor>::GravityLikeExternalForceVlasovDynamics(T omega_ )
    : ExternalForceDynamics<T,Descriptor>(omega_)
{ }

template<typename T, template<typename U> class Descriptor>
GravityLikeExternalForceVlasovDynamics<T,Descriptor>::GravityLikeExternalForceVlasovDynamics(HierarchicUnserializer& unserializer)
    : ExternalForceDynamics<T,Descriptor>(T())
{
    this->unserialize(unserializer);
}
...
template<typename T, template<typename U> class Descriptor>
GravityLikeExternalForceVlasovDynamics<T,Descriptor>* GravityLikeExternalForceVlasovDynamics<T,Descriptor>::clone() const {
    return new GravityLikeExternalForceVlasovDynamics<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor>
int GravityLikeExternalForceVlasovDynamics<T,Descriptor>::getId() const {
    return id;
}

template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceVlasovDynamics<T,Descriptor>::collide (
        Cell<T,Descriptor>& cell,
        BlockStatistics& statistics )
{
    T rhoBar = this->computeRhoBar(cell);
    ...
    T uSqr = dynamicsTemplates<T,Descriptor>::bgk_ma2_collision_vlasov(cell, rhoBar, j, this->getOmega());
    externalForceTemplates<T,Descriptor>::addGravityLikeForce(cell);
...
template<typename T, template<typename U> class Descriptor>
void GravityLikeExternalForceVlasovDynamics<T,Descriptor>::collideExternal (
        Cell<T,Descriptor>& cell, T rhoBar, Array<T,Descriptor<T>::d> const& j, T thetaBar, BlockStatistics& stat)
{
    Array<T,Descriptor<T>::d> u;
    this->computeVelocityExternal(cell, rhoBar, j, u);
    ...
    T uSqr = dynamicsTemplates<T,Descriptor>::bgk_ma2_collision_vlasov(cell, rhoBar, newJ, this->getOmega());
    externalForceTemplates<T,Descriptor>::addGravityLikeForce(cell);
...
template<typename T, template<typename U> class Descriptor>
T GravityLikeExternalForceVlasovDynamics<T,Descriptor>::computeEquilibrium (
        plint iPop, T rhoBar, Array<T,Descriptor<T>::d> const& j,
        T jSqr, T thetaBar) const
{
    T invRho = Descriptor<T>::invRho(rhoBar);
...
/// Vlasov dynamics à terminer et tester et enlever ce qui est inutile
/* *************** Class GuoExternalForceVlasovDynamics ********************************** */

template<typename T, template<typename U> class Descriptor>
int GuoExternalForceVlasovDynamics<T,Descriptor>::id =
    meta::registerGeneralDynamics<T,Descriptor,GuoExternalForceVlasovDynamics<T,Descriptor> >("Vlasov_ExternalForce_Guo");

/** \param omega_ relaxation parameter, related to the dynamic viscosity
 */
template<typename T, template<typename U> class Descriptor>
GuoExternalForceVlasovDynamics<T,Descriptor>::GuoExternalForceVlasovDynamics(T omega_ )
    : ExternalForceDynamics<T,Descriptor>(omega_)
{ }

template<typename T, template<typename U> class Descriptor>
GuoExternalForceVlasovDynamics<T,Descriptor>::GuoExternalForceVlasovDynamics(HierarchicUnserializer& unserializer)
    : ExternalForceDynamics<T,Descriptor>(T())
{
    this->unserialize(unserializer);
}
...
template<typename T, template<typename U> class Descriptor>
GuoExternalForceVlasovDynamics<T,Descriptor>* GuoExternalForceVlasovDynamics<T,Descriptor>::clone() const {
    return new GuoExternalForceVlasovDynamics<T,Descriptor>(*this);
}

template<typename T, template<typename U> class Descriptor>
int GuoExternalForceVlasovDynamics<T,Descriptor>::getId() const {
    return id;
}

template<typename T, template<typename U> class Descriptor>
void GuoExternalForceVlasovDynamics<T,Descriptor>::collide (
        Cell<T,Descriptor>& cell,
        BlockStatistics& statistics )
{
    T rhoBar = this->computeRhoBar(cell);
...
template<typename T, template<typename U> class Descriptor>
void GuoExternalForceVlasovDynamics<T,Descriptor>::collideExternal (
        Cell<T,Descriptor>& cell, T rhoBar, Array<T,Descriptor<T>::d> const& j, T thetaBar, BlockStatistics& stat)
{
    Array<T,Descriptor<T>::d> u;
    this->computeVelocityExternal(cell, rhoBar, j, u);
...
template<typename T, template<typename U> class Descriptor>
T GuoExternalForceVlasovDynamics<T,Descriptor>::computeEquilibrium (
        plint iPop, T rhoBar, Array<T,Descriptor<T>::d> const& j,
        T jSqr, T thetaBar) const
{
    T invRho = Descriptor<T>::invRho(rhoBar);
