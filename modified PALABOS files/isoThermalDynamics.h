...
/// Implementation of Vlasov dynamics
template<typename T, template<typename U> class Descriptor>
class VlasovDynamics : public IsoThermalBulkDynamics<T,Descriptor> {
public:
/* *************** Construction / Destruction ************************ */
    VlasovDynamics(T omega_);
    VlasovDynamics(HierarchicUnserializer& unserializer);

    /// Clone the object on its dynamic type.
    virtual VlasovDynamics<T,Descriptor>* clone() const;
